...
MODEL_SAVE_PATH = Path("models/ssd_hand_detect.pt")
...
data_loaders = {
    "train": DataLoader(image_datasets["train"], shuffle=True, batch_size=3),
...
def main():
    ...
    fig.savefig("data/hand_detect_model/ssd_trng.png")
